const StandaloneTweet = ({ content }) => {
  return (
    <div className="bg-white border border-gray-200 rounded-2xl px-5 py-4">
      <div className="flex gap-3">
        {/* Avatar */}
        <div className="shrink-0">
          <div className="w-12 h-12 rounded-full bg-hampton-primary flex items-center justify-center text-white font-bold text-base font-body">
            SP
          </div>
        </div>
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-1.5 mb-1">
            <span className="font-bold text-base text-hampton-text font-body">Sam Parr</span>
            ...
            <span className="text-hampton-text/40 text-base font-body">@TheSamParr</span>
          </div>

          <p className="text-base text-hampton-text font-body whitespace-pre-line leading-relaxed">
            {content.text}
          </p>

          {/* Engagement bar */}
          <div className="flex items-center gap-8 mt-4 pt-3 border-t border-gray-100 text-hampton-text/30">
...
export default StandaloneTweet;
